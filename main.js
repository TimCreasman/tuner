...
`,ht=class extends C{constructor(){super(...arguments);this.showSettings=!1;this.showDonation=!1}connectedCallback(){super.connectedCallback(),this.calculateDocumentHeight();let t=Tt.hexToRgb(f.getColor("primary")),e=Tt.hexToRgb(f.getColor("highlight")),r=Tt.hexToRgb(f.getColor("background"));this.style.setProperty("--primary-color",`${t.r}, ${t.g}, ${t.b}`),this.style.setProperty("--highlight-color",`${e.r}, ${e.g}, ${e.b}`),this.style.setProperty("--background-color",`${r.r}, ${r.g}, ${r.b}`)}calculateDocumentHeight(){let t=()=>{document.documentElement.style.setProperty("--doc-height",`${window.innerHeight}px`)};window.addEventListener("resize",t),t()}refreshTheme(t){let e=Tt.hexToRgb(t.value);this.style.setProperty("--"+t.color+"-color",`${e.r}, ${e.g}, ${e.b}`)}toggleSettings(){this.showDonation=!1,this.showSettings=!this.showSettings}renderSettings(){return this.showSettings?$`
        ...
        `}};ht.styles=[Hi,I,Kt],_([F()],ht.prototype,"showSettings",2),_([F()],ht.prototype,"showDonation",2),ht=_([P("tn-app")],ht);var We={};D(We,{DonationComponent:()=>Zt,DonationComponentStyles:()=>Hr});var Ve={};D(Ve,{default:()=>Ye});var Ye=M`
    /*!
...
`,Zt=class extends C{constructor(){super()}render(){return $`
        ...
        `}};Zt.styles=[Hr,Kt,Ye,I],Zt=_([P("tn-donation")],Zt);var Ze={};D(Ze,{AppearanceSettingsComponent:()=>Jt,AppearanceSettingsComponentStyles:()=>Br});var Ke={};D(Ke,{SettingsComponent:()=>Gt,SettingsComponentStyles:()=>G});var G=M`
    input {
...
`,Jt=class extends C{constructor(){super();this.settingsButtonHelperText="To get to this modal again without the settings button, double tap the screen."}updateComponent(t,e){let r=t.target.checked;f.setComponent(e,r)}render(){return $`
    ...
    `}};vt.styles=[G,I],_([rt()],vt.prototype,"frequencyOfA",2),_([rt()],vt.prototype,"accidentalMode",2),vt=_([P("tn-general-settings")],vt);var ir={};D(ir,{ThemeSettingsComponent:()=>mt});var lo=M`
    .color-row {
        align-items: center;
    }
...
`,mt=class extends C{constructor(){super();this.primaryColor=f.getColor("primary");this.highlightColor=f.getColor("highlight");this.backgroundColor=f.getColor("background")}updateColor(t,e){let r=t.target.value;f.setColor(e,r),this.updateLocalColor(e,r),this.dispatchEvent(new de(e,r))}resetColor(t){f.setColor(t,f.defaultConfig[t]),this.updateLocalColor(t,f.defaultConfig[t]),this.dispatchEvent(new de(t,f.defaultConfig[t]))}updateLocalColor(t,e){switch(t){case"primary":this.primaryColor=e;break;case"background":this.backgroundColor=e;break;case"highlight":this.highlightColor=e;break}}render(){return $`
            <tn-accordion>
        ...
        `}};mt.styles=[lo,G,I],_([rt()],mt.prototype,"primaryColor",2),_([rt()],mt.prototype,"highlightColor",2),_([rt()],mt.prototype,"backgroundColor",2),mt=_([P("tn-theme-settings")],mt);var or={};D(or,{AccordionComponent:()=>ie});var co=M`
    details > summary {
        list-style: none;
        padding: 1em;
...
`,ie=class extends C{render(){return $`
        ...
        `}};ie.styles=[co,I],ie=_([P("tn-accordion")],ie);var nr={};D(nr,{SettingsComponent:()=>oe});var mo=M`
    .modal {
        width: 110%;
        height: 110%;
        right: -5%;
...
`,B=class extends C{constructor(){super();this.note=new V(0);this.clarity=1;this.accuracy=0;this.accuracyBuffer=[B.bufferSize];this.heightAnimator=new we}updateHeightAnimation(){if(this.heightAnimatorReference)this.heightAnimator.reference=this.heightAnimatorReference;else return;let t=O.map(this.accuracy,[0,1],[90,25]);this.heightAnimator.to=t+""}update(t){super.update(t),!isNaN(Number(t.get("accuracy")))&&this.updateHeightAnimation()}render(){let t={"tuner-note-stroke-half":f.getComponent("noteOutline"),"tuner-note-octave":!0},e={"tuner-note-stroke-full":f.getComponent("noteOutline"),"tuner-note-letter":!0},r={"tuner-note-stroke-half":f.getComponent("noteOutline"),"tuner-note-accidental":!0};return $`
            <div class="tuner-note-container">
                <svg id="view" viewBox="0 2 100 100" height="100%" width="100%" xmlns="http://www.w3.org/2000/svg">
                    ...
                    ${f.getComponent("noteFill")?Le`<use href="#liquid-effect" mask="url(#note-mask)"/>`:x}
                    ${f.getComponent("noteOctave")?Le`<use href="#note-octave" class=${ye(t)}/>`:x}
        ...
        `}};B.styles=vo,B.bufferSize=25,_([F()],B.prototype,"note",2),_([F()],B.prototype,"clarity",2),_([F({type:Number})],B.prototype,"accuracy",2),_([yr("#height-animator")],B.prototype,"heightAnimatorReference",2),B=_([P("tn-tuner-note")],B);var Ot=class{set reference(t){this._reference=t}get from(){return this._reference.getAttribute("values").match(Ot.fromMatcher)[0]}set from(t){this._reference.setAttribute("values",this._reference.getAttribute("values").replace(Ot.fromMatcher,t))}get to(){return this._reference.getAttribute("values").match(Ot.toMatcher)[0]}set to(t){this._reference.setAttribute("values",this._reference.getAttribute("values").replace(Ot.toMatcher,t))}onEndEvent(){this.from=this.to}},we=Ot;we.fromMatcher=/-?\d+\.?\d*(?=;)/g,we.toMatcher=/-?\d+\.?\d*$/g;var mr={};D(mr,{SpokeComponent:()=>nt,TunerRingComponent:()=>J});var yi=Fe(bi());var $o=M`
  :host {
    --needle-degree: 0rad;
    --opacity: 1;
  }
...
`,nt=class extends C{constructor(){super(...arguments);this.scaleFactor=0;this.arcPosition=0;this.index=0;this.isMiddle=!1}connectedCallback(){super.connectedCallback(),this.isMiddle&&this.style.setProperty("background","rgb(var(--primary-color))"),this.setupPosition()}updated(){let t=(0,yi.default)(0,0,1,0),e=this.scaleFactor,r=O.map(this.scaleFactor,[0,1],[1,0]),i=t(e)*5,n=t(r)*15;this.style.setProperty("--x-scale",i+n+""),this.style.setProperty("--y-scale",i+"")}setupPosition(){let t=50*Math.cos(this.arcPosition)+50+"%",e=50*Math.sin(this.arcPosition)+50+"%";this.style.setProperty("bottom",t),this.style.setProperty("left",e),this.style.setProperty("--angle",this.arcPosition+"rad")}};nt.styles=So,_([F()],nt.prototype,"scaleFactor",2),_([F()],nt.prototype,"arcPosition",2),_([F()],nt.prototype,"index",2),_([F()],nt.prototype,"isMiddle",2),nt=_([P("tn-spoke")],nt);var hr={};D(hr,{TunerComponent:()=>at});var dt=class{static debug(...t){f.debugMode&&console.debug(t)}static error(...t){console.error(t)}};var dr=class{constructor(){this.audioContext=new AudioContext,this.analyserNode=new AnalyserNode(this.audioContext)}connect(){return br(this,null,function*(){let t;try{t=yield navigator.mediaDevices.getUserMedia({audio:{echoCancellation:!1,autoGainControl:!1,noiseSuppression:!1,latency:0}})}catch(r){dt.error(r)}this.sourceNode=this.audioContext.createMediaStreamSource(t);let e=this.audioContext.createBiquadFilter();return e.type="lowpass",e.frequency.setTargetAtTime(dr.lowpassThreshold,this.audioContext.currentTime,0),this.sourceNode.connect(e),e.connect(this.analyserNode),yield this.audioContext.resume(),this})}},ae=dr;ae.lowpassThreshold=8e3;var ur=class{constructor(t=new ae,e=17){this.refreshRate=e,this._audioSource=t,this.algorithms=new Map,this.algorithms.set("McLeod",new Je(this._audioSource)),this.algorithms.set("YIN",new Qe),this.algorithms.set("AMDF",new Xe),this.algorithms.set("Dynamic Wavelet",new tr)}static Instance(t=new ae,e=17){return this._instance||(this._instance=new this(t,e))}startListening(){this._audioSource.connect().then(()=>{this.intervalReference=window.setInterval(this.listen.bind(this),this.refreshRate)})}stopListening(){window.clearInterval(this.intervalReference)}setOnListen(t){this.onListen=t}get pitch(){return this._algorithmResult.pitch}get clarity(){return this._algorithmResult.clarity}get volume(){return this._algorithmResult.volume}get audioSource(){return this._audioSource}set audioSource(t){t.analyserNode.smoothingTimeConstant=1,this._audioSource=t}listen(){this._algorithmResult=this.algorithms.get(f.algorithm).detect(this._audioSource),this.pitch===-1&&dt.debug("Pitch not detected.",this._algorithmResult.pitch,this._algorithmResult.clarity),this.onListen(this._algorithmResult.pitch,this._algorithmResult.clarity,this._algorithmResult.volume)}};var at=class extends C{constructor(){super(...arguments);this.pitchDetectorService=ur.Instance();this.note=new V(0);this.accuracy=0;this.clarity=1;this.volume=0;this.inTune=!1}connectedCallback(){super.connectedCallback(),this.pitchDetectorService.setOnListen((t,e,r)=>{if(this.clarity=e,this.volume=r,r<.01||e<.95)return;this.note=It.freqToNote(t);let i=It.noteToPitch(this.note),n=It.noteToPitch(new V(this.note.index-1)),a=It.noteToPitch(new V(this.note.index+1)),s;t<i?(this.pitchAccidental=gt.flat,s=O.map(t,[n,i],[-1,1])):(this.pitchAccidental=gt.sharp,s=O.map(t,[a,i],[-1,1])),s<0&&(s=0),this.inTune=s>.95,this.accuracy=s}),this.pitchDetectorService.startListening()}disconnectedCallback(){super.disconnectedCallback(),this.pitchDetectorService.stopListening()}updateOscillatorFrequency(t){let e=this.pitchDetectorService.audioSource;e.frequency=Number(t.target.value)}setPlayback(t){t.target.checked?this.pitchDetectorService.audioSource.sourceNode.connect(this.pitchDetectorService.audioSource.audioContext.destination):this.pitchDetectorService.audioSource.sourceNode.disconnect(this.pitchDetectorService.audioSource.audioContext.destination)}resumeContext(){this.pitchDetectorService.audioSource.audioContext.resume().then(()=>{dt.debug("Audio source resumed")},t=>{dt.error("Audio source failed to resume",t)})}render(){return $`
 ...
 <div>
        ...
        `}};_([F()],at.prototype,"note",2),_([F()],at.prototype,"accuracy",2),_([F()],at.prototype,"clarity",2),_([F()],at.prototype,"volume",2),_([F()],at.prototype,"pitchAccidental",2),at=_([P("tn-tuner")],at);var Co=[Be,We,Ze,er,rr,Ke,ir,or,He,Ve,Ue,nr,ar,cr,mr,hr],wi=Co;wi[0].default;})();
/**
 * @license
